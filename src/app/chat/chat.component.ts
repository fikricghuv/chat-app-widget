...
import {ChangeDetectionStrategy, Component, ViewChild, ElementRef, OnInit, OnDestroy, ChangeDetectorRef, NgZone } from '@angular/core';
...
import { RoomConversationModel } from '../model/room.model'; 
...
export class ChatComponent implements OnInit, OnDestroy {
  ...
  formatMessageTime(isoDateString: string): string {
    ...
    return isSameDay
      ? messageDate.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) // contoh: 14:05
      : `${messageDate.getDate().toString().padStart(2, '0')}/${
          (messageDate.getMonth() + 1).toString().padStart(2, '0')
        }/${messageDate.getFullYear()} ${messageDate
